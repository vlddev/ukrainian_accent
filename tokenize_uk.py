...
def text2sent(string):
    """
    Tokenize input text to paragraphs and sentences

    Tokenization to paragraphs is done using simple Newline algorithm
    For sentences tokenizers above is used

    :param string: Text to tokenize
    :type string: str or unicode
    :return: text, tokenized into paragraphs, sentences
    :rtype: list of list of sentences
    """
    rez = []
    for part in string.split('\n'):
        par = []
